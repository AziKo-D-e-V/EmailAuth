...
app.post("/register", async (req, res) => {
  ...
  const mailData = {
    ...
    html: `<b>Login code:${verifyCode}</b><br> Do not give this code to anyone, even if they say they are from our Site<br/>`,
  };
...
app.post("/register/vercode/:id", async (req, res) => {
  const { id } = req.params;
...
const bootstrap = async (app) => {
  await connect("mongodb://127.0.0.1:27017/emailAuth");
  app.listen(4000, () => {
    console.log(4000);
  });
};
